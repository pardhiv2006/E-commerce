    ...
    try {
        ...
        for (const product of products) {
            ...
            if (product.name === 'iPhone 15 Pro Max') {
                ...
                await fetch(`http://127.0.0.1:5001/api/products/${product._id || product.id}`, {
                    method: 'PUT',
            ...
            if (newImage) {
                ...
                // Prune products without Descriptive Visuals
        ...
        console.log(`Updated: ${updatedCount} products with precisely verified visuals.`);
        console.log(`Pruned: ${deletedCount} products (removed to maintain catalog quality).`);
    } catch (err) {
